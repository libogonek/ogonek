...
// # Codec concept
// Assume C is a Codec type, codec is an instance of C, s is an instance of
// C::state, u is a codepoint, b is a byte, [bb, be) is a range of input
// iterators on bytes, [cb, ce) is a range of input iterators on codepoints, bo
// is an output iterator on bytes, and co is an output iterator on codepoints.
//

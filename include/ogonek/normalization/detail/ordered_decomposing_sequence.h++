...
#ifndef OGONEK_DETAIL_ORDERED_DECOMPOSING_SEQUENCE_HPP
#define OGONEK_DETAIL_ORDERED_DECOMPOSING_SEQUENCE_HPP
    ...
    namespace detail {
        ...
        */
        ...
        struct combining_class_order {
            small_vector<code_point, 4> operator()(small_vector<code_point, 4> v) const {
        ...
        template <typename Sequence, bool Compatibility>
        using ordered_decomposing_base = seq::result_of::bind<decomposing_sequence<Sequence, Compatibility>, combining_class_order>;
        template <typename Sequence, bool Compatibility>
        struct ordered_decomposing_sequence
        : ordered_decomposing_base<Sequence, Compatibility> {
            template <typename SequenceF>
            ordered_decomposing_sequence(SequenceF&& sequence)
            : ordered_decomposing_base<Sequence, Compatibility>(
                seq::bind(decompose<Compatibility>(std::forward<SequenceF>(sequence)),
                          combining_class_order{})) {}
        };
...
#endif // OGONEK_DETAIL_ORDERED_DECOMPOSING_SEQUENCE_HPP
